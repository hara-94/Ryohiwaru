...
final class InputAddPresenter: InputAddBasePresenter<InputAddDepedency> {
    ...
    override func viewDidLoad() {
        ...
        let viewModel = InputAddViewModel(categories: [
            .init(icon: UIImage(named: "food")!, title: "食費"),
            .init(icon: UIImage(named: "train")!, title: "交通費"),
            .init(icon: UIImage(named: "hotel")!, title: "宿泊費"),
            .init(icon: UIImage(named: "sight")!, title: "観光"),
            .init(icon: UIImage(named: "activity")!, title: "アクティビティ"),
            .init(icon: UIImage(named: "else")!, title: "その他"),
        ])
